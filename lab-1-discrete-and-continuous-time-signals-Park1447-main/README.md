...
2. Lab instructions can be found in [`lab01_instructions.pdf`](lab01_instructions.pdf), but
   the [`lab01_report.ipynb`](lab01_report.ipynb) should be your primary reference.
